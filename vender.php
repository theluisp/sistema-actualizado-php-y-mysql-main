    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <a href="#" class="btn btn-primary btn_new_cliente"><i class="fa fa-user-plus" aria-hidden="true">
</i> Nuevo Cliente</a>
            </div>
            <div class="card">
                <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div id="acciones_venta" class="form-group">
                        ...
                        <a href="#" class="btn btn-primary" id="btn_facturar_venta"><i class="fa fa-money" aria-hidden="true"></i>
 Generar Venta</a>
                    </div>
                </div>
            </div>
