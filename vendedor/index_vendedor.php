 ...
 <body>
  ...
  <div class="col-sm-6">
    <div class="card  border-0"><center>
      <div class="card-body">
          	<center>	  <img src="../img/INVENTARIO.png" style=" max-width:17%;"></center>
        <h5 class="card-title">Inventario general de mi sucursal <?php echo "$sucursal3";?></h5>
    ...
    <div class="card  border-0"><center>
      <div class="card-body ">
          	<center>	  <img src="../img/sucursales.png" style=" max-width:35%;"></center>
        <h5 class="card-title">Inventario general de todas sucursales</h5>
        <p class="card-text">Visualizar todos los productos todas las sucursales</p>
    ...
    <div class="card  border-0"><center>
      <div class="card-body">
          	<center>	  <img src="../img/caja_registradora.jpg" style=" max-width:25%;"></center>
        <h5 class="card-title">Realizar venta <?php echo "$sucursal3";?></h5>
        <p class="card-text">Entrar al sistema de venta</p>
        <a href="../sistema/nueva_venta.php" class="btn btn-primary">Aceptar</a>
      </div></center>
    </div>
  </div>
  ...
  <div class="col-sm-6">
    <div class="card  border-0"><center>
      <div class="card-body">
          	<center>	  <img src="../img/misventas.webp" style=" max-width:50%;"></center>
        <h5 class="card-title">Mis ventas</h5>
        <p class="card-text">Visualizar historial de mis ventas realizadas</p>
        <a href="../sistema/ventas.php" class="btn btn-primary">Aceptar</a>
      </div></center>
    </div>
  </div>
</div>
